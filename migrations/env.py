...
def run_migrations_online() -> None:
    ...
    for table in Base.metadata.tables.values():
        schema = "org_default" if not table.schema else table.schema
    ...
    with connectable.connect() as connection:
        ...
        with context.begin_transaction():
            try:
                ...
                if current_context and current_context.connection:
                    current_context.connection.execute(text("ROLLBACK"))
